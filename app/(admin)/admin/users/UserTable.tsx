                ...
                <td className="px-6 py-4">
                  <div className="flex gap-2">
                    <button
                      ...
                      className="text-xs px-3 py-1 rounded-lg bg-gray-700 hover:bg-gray-600 text-gray-300 transition-colors disabled:opacity-30 disabled:cursor-not-allowed"
                    >
                    ...
                    {user.role !== "admin" && (
                      <button
                        ...
                        className="text-xs px-3 py-1 rounded-lg bg-purple-700/40 hover:bg-purple-700/60 text-purple-300 transition-colors disabled:opacity-50"
                      >
                        Make Admin
                      </button>
                    )}
