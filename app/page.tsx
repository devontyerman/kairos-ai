    ...
    <main className="min-h-screen bg-white flex flex-col">
      ...
      <nav className="border-b border-gray-200 px-6 py-4 flex items-center justify-between">
        <div className="flex items-center gap-2">
          ...
          <span className="font-semibold text-gray-900 text-lg">Kairos AI</span>
        </div>
        <Link
          href="/sign-in"
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-6 py-24 text-center">
        <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-blue-50 border border-blue-200 text-blue-600 text-xs font-medium mb-8">
        ...
        <h1 className="text-5xl md:text-6xl font-bold text-gray-900 mb-6 max-w-3xl leading-tight">
          ...
          <span className="text-blue-600">AI Prospect</span>
        </h1>
        ...
        <div className="flex flex-col sm:flex-row gap-4 items-center">
          ...
          <span className="text-gray-400 text-sm">Invite-only access</span>
        </div>
